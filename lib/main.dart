...
// ==========================================
// BACKGROUND AMBIENT GLOW COMPOSER
// ==========================================
...
// ==========================================
// 1. INTRO SCREEN ONE (Logo Only - Auto Transitions)
// ==========================================
                ...
                child: AnimatedBuilder(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Native Pangasinan Touch Added Here
                      Container(
...
// ==========================================
// 2. INTRO SCREEN TWO (With Get Started Button)
// ==========================================
                      ...
                      child: BackdropFilter(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              // MATCHING HERO WRAPPER TO SEAMLESSLY MORPH LOGO
                              Hero(
                                tag: 'tawir_logo_hero',
                                child: Material(
                                  color: Colors.transparent,
...
class _ChatScreenState extends State<ChatScreen> with TickerProviderStateMixin {
  ...
  bool isTyping = false;
  bool showArchived = false; // Toggle to view archived chats
  ...
  void _toggleArchiveSession(String sessionId) {
    setState(() {
      ...
      // If archiving the active session, clear the screen
  ...
  // --- FEATURE: Rename Conversation Title ---
  ...
  @override
  Widget build(BuildContext context) {
    // Filter sessions depending on whether we are viewing active or archived lists
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              // Filter Toggle: Active vs Archived
              Padding(
      ...
      body: Stack(
        children: [
          ...
          SafeArea(
            child: Column(
              children: [
                // Modern App Bar with History Toggle Button
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      // Tawir Logo Avatar & Clean Status
                      Container(
                        width: 38,
                        height: 38,
                        decoration: BoxDecoration(
